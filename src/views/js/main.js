...
var resizePizzas = function(size) {
  ...
  // For each slider selector inputs define a new width that will be used by the for loop
  function changePizzaSizes(size) {
    ...
    // changes randomPizzaContainer width according to the selector slider inputs
...
function updatePositions() {
  ...
  // Creates a variable to store all of the pizzas in the background
